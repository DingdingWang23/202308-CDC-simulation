...
# 定义文件夹路径
folder_path = r'C:\\Users\\丁丁\\Desktop\\上海住建测评\\total_已处理'
...
folder_path = r'C:\\Users\\丁丁\\Desktop\\上海住建测评\\每个人讲的话_1110'
...
f = open(r'C:\\Users\\丁丁\\Desktop\\单元组词典_1110.txt', "w")
print(counter,file=f)
f.close()


'''
with open(r'C:\\Users\\丁丁\\Desktop\\单元组词典_1110.txt', 'r') as file:
    # 读取文件内容
    contents = file.read()
...
filtered_list = [item for item in data_list if item[1] <= 20]
...
frequent_items= apriori(df, min_support=0.0005, use_colnames=True, max_len=2).sort_values(by='support', ascending=False)
...
f = open(r'C:\\Users\\丁丁\\Desktop\\多元组词典_1110.txt', "w")
