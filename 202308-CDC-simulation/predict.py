...
parser.add_argument('--device', choices=['cpu', 'gpu'], default="cpu", help="Select which device to train model, defaults to cpu.")
...
if __name__ == "__main__":
    ...
    input_folder = r"C:\Users\丁丁\Desktop\教学+科研+学生思政和活动_all_sentence_output"
    output_folder = r"C:\Users\丁丁\Desktop\教学+科研+学生思政和活动_node_output"
    ...
    for file_name in file_list:
        if file_name.endswith(".tsv"):
            ...
            file_path = r'C:\\Users\\丁丁\\Desktop\\mapping_教学+科研+学生思政和活动_1003.xlsx'
            ...
            for query in result.keys():
                if result[query]['similarity'] > 0.45:
