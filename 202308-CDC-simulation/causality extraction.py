...
def test(input_file,output_file):
    ...
    cause_list = []
    effect_list = []
    f = open(input_file, encoding='gbk')
    f=f.readlines()
    f = ''.join(f)
...
f = open(r"C:\\Users\\丁丁\\Desktop\\node_list0824.txt",encoding='utf-8')
...
input_folder = r"C:\Users\丁丁\Desktop\单人面试文本"
output_folder_1 = r"C:\Users\丁丁\PycharmProjects\PaddleNLP\examples\text_matching\simbert\单人面试文本_causality_pair_output"
output_folder_2 = r"C:\Users\丁丁\PycharmProjects\PaddleNLP\examples\text_matching\simbert\单人面试文本_all_sentence_output"

output_folder = r"C:\Users\丁丁\Desktop\其他事务\备课\2023暑期-卫健委培训\output"
