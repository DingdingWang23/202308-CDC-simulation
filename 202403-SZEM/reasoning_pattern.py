...
input_folder = r'C:\\Users\\丁丁\\Desktop\\深圳演练\\for_reasoning'
output_file = r'C:\\Users\\丁丁\\Desktop\\深圳演练\\reasoning.csv'
...
with open(output_file, 'a', newline='', encoding='utf-8-sig') as csvfile:
    ...
    for filename in os.listdir(input_folder):
        ...
        if filename.endswith('.txt'):
            ...
            writer.writerow([filename.replace(".txt", ""), 1, count_pattern_1])
            writer.writerow([filename.replace(".txt", ""), 2, count_pattern_2])
            writer.writerow([filename.replace(".txt", ""), 3, count_pattern_3])
            writer.writerow([filename.replace(".txt", ""), 4, count_pattern_4])
            writer.writerow([filename.replace(".txt", ""), 5, count_pattern_5])
