...
input = pd.read_csv(r"C:\\Users\\丁丁\\Desktop\\node_医院建设_1002.csv")
...
output_file = r'C:\\Users\\丁丁\\Desktop\\reasoning_1006_new.csv'
...
with open(output_file, 'a', newline='', encoding='utf-8-sig') as csvfile:
    ...
    for filename in os.listdir(input_folder):
        ...
        if filename.endswith('.txt'):
            ...
            writer.writerow([filename.replace(".txt", ""), '医院建设', 1, count_pattern_1])
            writer.writerow([filename.replace(".txt", ""), '医院建设', 2, count_pattern_2])
            writer.writerow([filename.replace(".txt", ""), '医院建设', 3, count_pattern_3])
            writer.writerow([filename.replace(".txt", ""), '医院建设', 4, count_pattern_4])
            writer.writerow([filename.replace(".txt", ""), '医院建设', 5, count_pattern_5])
